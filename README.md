...
| 3 | **ThaiTutor AI** | [n00n0i/thai-tutor-ai](https://github.com/n00n0i/thai-tutor-ai) | 🚀 Deployed ✅ | 🥑 กะทิ | Live: http://100.68.71.89:3782 · LLM: deepseek-v4-pro (Ollama Cloud) · Thai UI + Kanit font · พี่ติวเตอร์ไทย personality · ภาษาถิ่น: กลาง/อีสาน/ใต้ · **Dialect UI ✅ สมบูรณ์** (backend dialect field + frontend state + UI buttons) · Dogfood 17/17 tests ผ่าน · Context truncation fix |
